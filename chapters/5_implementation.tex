...
\begin{itemize}
    ...
    \item \mintinline{text}{0x02}: ISO-TP metadata showing the length of the layer 7 payload.
    \item \mintinline{text}{0x10}: The SID for the DSC service.
...
\end{minted}
\caption{Implementation of an enumerator scanning the DSC service.}
...
\end{minted}
\caption{The enumerator for the RC service only scanning Type1.}
