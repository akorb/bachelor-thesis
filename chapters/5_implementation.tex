...
In this chapter, the theoretical explanations of the previous chapters are translated into practical implementations of Python code.

\section{UDS implementation of the Scapy library}

First, to understand the later request generations for each service it is explained how to create UDS data with the Scapy library. And then, for completeness, how the data is sent.
