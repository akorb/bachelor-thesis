...
\subsection{Scapy modules}

\begin{figure}[htb]
    \centering
    \includegraphics[width=0.81\textwidth]{uml/context}
...
\begin{itemize}
    \item An ISOTPSocket for communication with the ECU.
    \item The UDS data definitions to generate requests and interpret responses (see \autoref{subsec:uds-scapy}).
