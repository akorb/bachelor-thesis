...
First, to understand the later request generations for each service it is explained how to create UDS data with the Scapy library. Finally, for completeness, how the data is transmitted.
