...
For sake of completeness, the \mintinline{text}{cansend} command (line 4) sends a CAN packet with the identifier 0x123 and the payload \mintinline{text}{0x01 0x02}:
