...
First, Chapter 2 describes the basics for understanding this thesis. After that, Chapter 3 shows where and what data was collected for the analysis and how it was used for profiling. Then, in Chapter 4, the approaches based on the collected data are elaborated. Consequently, their implementation is explained in Chapter 5. The observed results of the implementations are presented in Chapter 6. Finally, Chapter 7 summarizes the results of this thesis and provides an outlook on future work.
